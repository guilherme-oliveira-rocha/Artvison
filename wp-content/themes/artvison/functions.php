    ...
    $posttypes = array(
		...
		'informacoes' => array(
            'labels' => array(
                ...
                'menu_name'          => __('Informações'),
                'name_admin_bar'     => __('Informações'),
                'add_new'            => __('Nova Informação'),
                'add_new_item'       => __('Nova Informação'),
                'new_item'           => __('Nova Informação'),
                'edit_item'          => __('Editar Informação'),
                'view_item'          => __('VerInformações'),
                'all_items'          => __('Informações'),
                'search_items'       => __('Procurar por Informações'),
                'parent_item_colon'  => __('Videos pai:'),
                'not_found'          => __('Nenhuma informação encontrada.'),
                'not_found_in_trash' => __('Nenhuma informação encontrada na lixeira.')
			),
            'description' => __('Informações'),
            'rest_base' =>'custom/informacao',
            'has_archive' => 'biblioteca/informacao',
            'supports'    => array('title', 'thumbnail', 'editor', 'author', 'excerpt', 'page-attributes'),
            'taxonomy'    => array(
                ...
                'category_information' => array(
                    ...
                    'show_admin_column' => true,
                    'query_var'         => true,
                    'rewrite'           => array('slug' => 'category_information'),
                    'show_in_rest'      => true,
                    'rest_base'         => 'category_information'
